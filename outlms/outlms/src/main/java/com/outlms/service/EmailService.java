...
public class EmailService {
    ...
    /**
     * Send registration confirmation email (HTML, professional template with header).
    ...
    public void sendRegistrationConfirmation(StudentRegistration registration) {
        try {
            ...
            String htmlBody = "<!DOCTYPE html><html><head><meta charset=\"UTF-8\"><meta name=\"viewport\" content=\"width=device-width,initial-scale=1\">" +
                    ...
                    "<p style=\"margin:0 0 16px;font-size:16px;color:#334155;line-height:1.6;\">Dear <strong>" + escapeHtml(fullName) + "</strong>,</p>" +
                    ...
                    "<p style=\"margin:0 0 4px;font-size:15px;color:#0f172a;\"><strong>Registration ID:</strong> " + escapeHtml(regId) + "</p>" +
                    "<p style=\"margin:0 0 4px;font-size:15px;color:#0f172a;\"><strong>Name:</strong> " + escapeHtml(fullName) + "</p>" +
                    "<p style=\"margin:0 0 4px;font-size:15px;color:#0f172a;\"><strong>Email:</strong> " + escapeHtml(email) + "</p>" +
                    "<p style=\"margin:0 0 0;font-size:15px;color:#0f172a;\"><strong>Phone:</strong> " + escapeHtml(phone) + "</p>" +
                    "</td></tr></table>" +
                    ...
                    "<p style=\"margin:0;font-size:13px;color:#64748b;\">Best regards,<br/><strong>" + SYSTEM_NAME + "</strong></p>" +
    ...
    public void sendApprovalEmail(StudentRegistration registration, String username, String password) {
        ...
        try {
            ...
            String htmlBody = "<!DOCTYPE html><html><head><meta charset=\"UTF-8\"><meta name=\"viewport\" content=\"width=device-width,initial-scale=1\"></head>" +
                    ...
                    "<div style=\"font-size:14px;color:rgba(255,255,255,0.9);margin-top:6px;\">" + SYSTEM_NAME + "</div>" +
                    "</td></tr>" +
                    "<tr><td style=\"padding:40px 40px 32px;\">" +
                    "<p style=\"margin:0 0 16px;font-size:16px;color:#334155;line-height:1.6;\">Dear <strong>" + escapeHtml(fullName) + "</strong>,</p>" +
                    ...
                    "<p style=\"margin:0 0 4px;font-size:15px;color:#0f172a;\"><strong>Username:</strong> " + escapeHtml(username) + "</p>" +
                    "<p style=\"margin:0 0 0;font-size:15px;color:#0f172a;\"><strong>Temporary password:</strong> " + escapeHtml(password) + "</p>" +
                    "</td></tr></table>" +
                    "<div style=\"margin-top:24px;padding:16px 20px;background:#fef3c7;border-radius:10px;border-left:4px solid #f59e0b;\">" +
                    ...
                    "</div>" +
                    "<p style=\"margin:24px 0 0;font-size:15px;color:#64748b;\">Registration ID: " + escapeHtml(registration.getRegistrationId()) + " &nbsp;|&nbsp; Name: " + escapeHtml(fullName) + "<br/>Course: " + escapeHtml(course) + " – " + escapeHtml(branch) + " (Year " + academicYear + ")</p>" +
                    "<p style=\"margin:16px 0 0;font-size:15px;color:#334155;\">You can now access the <strong>" + escapeHtml(roleLabel) + " portal</strong>.</p>" +
                    "</td></tr>" +
                    "<tr><td style=\"padding:24px 40px;background:#f8fafc;border-top:1px solid #e2e8f0;text-align:center;\">" +
                    "<p style=\"margin:0;font-size:13px;color:#64748b;\">Best regards,<br/><strong>" + SYSTEM_NAME + "</strong></p>" +
                    "</td></tr></table></td></tr></table></body></html>";
    ...
    public void sendRejectionEmail(StudentRegistration registration, String reason) {
        ...
        try {
            ...
            String htmlBody = "<!DOCTYPE html><html><head><meta charset=\"UTF-8\"></head>" +
                    ...
                    "<tr><td style=\"padding:20px 24px;\">" +
                    "<p style=\"margin:0 0 4px;font-size:15px;color:#0f172a;\"><strong>Registration ID:</strong> " + escapeHtml(registration.getRegistrationId()) + "</p>" +
                    "<p style=\"margin:0 0 0;font-size:15px;color:#0f172a;\"><strong>Reason:</strong> " + escapeHtml(reasonText) + "</p>" +
                    "</td></tr></table>" +
    ...
    public void sendBookIssuedEmail(BookIssuance issuance) {
        try {
            ...
            String htmlBody = "<!DOCTYPE html><html><head><meta charset='UTF-8'></head><body style=\"font-family:'Segoe UI',sans-serif;background:#f9fafb;padding:24px;\">"
                    ...
                    + "<p style='margin:0 0 8px;color:#111827;'><strong>Title:</strong> " + escapeHtml(issuance.getBook().getTitle()) + "</p>"
                    + "<p style='margin:0 0 8px;color:#111827;'><strong>Issue Date:</strong> " + issuance.getIssueDate() + "</p>"
                    + "<p style='margin:0 0 8px;color:#111827;'><strong>Due Date:</strong> " + issuance.getDueDate() + "</p>"
    ...
    public void sendBookReturnedEmail(BookIssuance issuance) {
        try {
            ...
            String htmlBody = "<!DOCTYPE html><html><head><meta charset='UTF-8'></head><body style=\"font-family:'Segoe UI',sans-serif;background:#f9fafb;padding:24px;\">"
                    ...
                    + "<p style='margin:0 0 8px;color:#111827;'><strong>Title:</strong> " + escapeHtml(issuance.getBook().getTitle()) + "</p>"
                    + "<p style='margin:0 0 8px;color:#111827;'><strong>Return Date:</strong> " + issuance.getReturnDate() + "</p>"
    ...
    public void sendOverdueReminderEmail(BookIssuance issuance) {
        try {
            ...
            String htmlBody = "<!DOCTYPE html><html><head><meta charset='UTF-8'></head><body style=\"font-family:'Segoe UI',sans-serif;background:#f9fafb;padding:24px;\">"
                    ...
                    + "<p style='margin:0 0 8px;color:#111827;'><strong>Title:</strong> " + escapeHtml(issuance.getBook().getTitle()) + "</p>"
                    + "<p style='margin:0 0 8px;color:#b91c1c;'><strong>Due Date:</strong> " + issuance.getDueDate() + "</p>"
    ...
    public void sendMembershipAssignedEmail(StudentMembership membership) {
        try {
            ...
            String htmlBody = "<!DOCTYPE html><html><head><meta charset='UTF-8'></head><body style=\"font-family:'Segoe UI',sans-serif;background:#f9fafb;padding:24px;\">"
                    ...
                    + "<p style='margin:0 0 8px;color:#111827;'><strong>Plan:</strong> " + escapeHtml(membership.getPlan().getName()) + " (" + membership.getPlan().getTier() + ")</p>"
                    + "<p style='margin:0 0 8px;color:#111827;'><strong>Book Allowance:</strong> " + membership.getPlan().getBookAllowance() + " books</p>"
                    + "<p style='margin:0 0 8px;color:#111827;'><strong>Loan Duration:</strong> " + membership.getPlan().getLoanDurationDays() + " days</p>"
    ...
    public void sendMembershipRevokedEmail(StudentMembership membership) {
        try {
            ...
            String htmlBody = "<!DOCTYPE html><html><head><meta charset='UTF-8'></head><body style=\"font-family:'Segoe UI',sans-serif;background:#f9fafb;padding:24px;\">"
                    ...
                    + "<p style='margin:0 0 8px;color:#111827;'><strong>Previous Plan:</strong> " + escapeHtml(membership.getPlan().getName()) + "</p>"
